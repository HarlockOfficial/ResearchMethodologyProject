...
def main(dataset_path: str, selected_model: ModelType, base_model_path:str=None):
    ...
    for epochs in epochs_list:
        ...
        train_loss, train_accuracy, test_loss, test_accuracy = utils.model_train(model, dataset_train.reset_index(drop=True),
                        dataset_test.reset_index(drop=True), epochs=epochs, batch_size=16, device=device)
